  ...
  <div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content flex flex-col">
      ...
      <div class="navbar bg-base-100 shadow-md">
        ...
        <div class="flex-1">
          <span class="text-xl font-bold">智能家教推荐系统 - 管理后台</span>
        </div>
        <div class="flex-none">
      ...
      <!-- 主要内容区域 -->
      <div class="p-4 flex-grow bg-base-200">
        <slot></slot>
      </div>
    </div>
    ...
    <div class="drawer-side">
      ...
      <ul class="menu p-4 w-64 h-full bg-base-200 text-base-content">
        <li class="mb-2 font-bold text-lg">
        ...
        <li>
          <router-link to="/teacher-verification">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
